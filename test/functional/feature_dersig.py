...
class BIP66Test(LibraTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # librad is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and librad produces more specific reject
            # reasons.
