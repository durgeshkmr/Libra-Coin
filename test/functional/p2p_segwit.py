...
class SegWitTest(LibraTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older librad's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let librad fill it in.
