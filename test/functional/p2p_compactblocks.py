...
# TestP2PConn: A peer we use to send messages to librad, and store responses.
...
class CompactBlocksTest(LibraTestFramework):
    ...
    # This test actually causes librad to (reasonably!) disconnect us, so do this last.
    ...
    # Test that librad requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for librad to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # librad will not send blocktxn responses for blocks whose height is
