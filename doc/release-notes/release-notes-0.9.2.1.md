Libra Core version 0.9.2.1 is now available from:

  https://libra.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 LIBRA to 0.01 LIBRA
...
- Fix "Start libra on system login"
