Libra Core version 0.16.1 is now available from:

  <https://libracore.org/bin/libra-core-0.16.1/>
...
- #12843 `df38b13` Test starting librad with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure librad processes are cleaned up when tests end (sdaftuar)
