Libra version 0.5.4 is now available for download at:
http://sourceforge.net/projects/libra/files/Libra/libra-0.5.4/
...
http://gitorious.org/libra/librad-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Libra-Qt notifications under Growl 1.3.
Increase required age of Libra-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxLibra properly when installing Libra-Qt over it. (Windows)
