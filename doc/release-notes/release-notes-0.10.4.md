Libra Core version 0.10.4 is now available from:

  <https://libra.org/bin/libra-core-0.10.4/>
...
- #6953 `43c2789` Split libra-tx into its own package
- #6953 `dfe0d4d` Include libra-tx binary on Debian/Ubuntu
