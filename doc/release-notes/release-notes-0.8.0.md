Libra-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/libra/files/Libra/libra-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Libra
...
New/changed settings (command-line or libra.conf file)
--------------------------------------------------------
