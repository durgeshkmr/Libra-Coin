Download URL: https://sourceforge.net/projects/libra/files/Libra/libra-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 LIBRA fee schedule (users still pay 0.01 LIBRA per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #libra00 - #libra99
