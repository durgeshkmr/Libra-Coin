Libra Core version 0.9.4 is now available from:

  https://libra.org/bin/0.9.4/
...
this update is incompatible with the Libra system and could lead to consensus
forks.

Libra Core released binaries from https://libra.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~libra/+archive/ubuntu/libra
- A third-party or self-compiled Libra Core

upgrade to Libra Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
