Libra Core version 0.13.2 is now available from:

  <https://libra.org/bin/libra-core-0.13.2/>
...
- #8908 `4a974b2` Update libra-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow libra-tx to create v2 transactions (libradrak)
