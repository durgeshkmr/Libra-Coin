...
* libra.conf: contains configuration settings for librad or libra-qt
* librad.pid: stores the process id of librad while running
...
* debug.log: contains debug information and general logging generated by librad or libra-qt
