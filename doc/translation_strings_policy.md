...
This document provides guidelines for internationalization of the Libra Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `libra_en.ts` remains unchanged.
