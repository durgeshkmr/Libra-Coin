/* src/config/libra-config.h.  Generated from libra-config.h.in by configure.  */
/* src/config/libra-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef LIBRA_CONFIG_H

#define LIBRA_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Libra Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Libra Core"
...
#define PACKAGE_BUGREPORT "https://github.com/libra/libra/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Libra Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Libra Core 0.17.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "libra"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://libracore.org/"
