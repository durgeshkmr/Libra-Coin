...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " libra-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  libra-tx [options] <hex-tx> [commands]  Update hex-encoded libra transaction\n" +
            "or:     libra-tx [options] -create [commands]   Create hex-encoded libra transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded libra transaction
