...
#ifndef LIBRA_KEYSTORE_H
#define LIBRA_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/libra/bips/blob/master/bip-0013.mediawiki
