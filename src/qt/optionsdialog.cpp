    ...
    mapper(0)
{
    ...
    ui->libraAtStartup->setToolTip(ui->libraAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->libraAtStartup->setText(ui->libraAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openLibraConfButton->setToolTip(ui->openLibraConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new LibraUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->libraAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openLibraConfButton_clicked()
{
