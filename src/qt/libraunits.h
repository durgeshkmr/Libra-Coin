...
#ifndef LIBRA_QT_LIBRAUNITS_H
#define LIBRA_QT_LIBRAUNITS_H
...
/** Libra unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class LibraUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit LibraUnits(QObject *parent);

    /** Libra units.
      @note Source: https://en.libra.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        LIBRA,
...
typedef LibraUnits::Unit LibraUnit;

#endif // LIBRA_QT_LIBRAUNITS_H
