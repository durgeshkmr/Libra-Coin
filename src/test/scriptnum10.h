...
#ifndef LIBRA_TEST_SCRIPTNUM10_H
#define LIBRA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Libra Core 0.10.0, for cross-comparison.
 */
public:
